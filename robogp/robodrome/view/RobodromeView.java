...
public class RobodromeView extends JComponent {
    ...
    /**
     * @return true se la vista è impostata per seguire automaticamente
    ...
    /**
     * @return true se c'è un'animazione in riproduzione.
     */
     ...
     * e/o rotazione) di un robot. Attenzione: non vi è alcuna verifica
     ...
     * Attenzione: non pu&ograve; essere invocato quando c'è
    ...
    /**
     * Posiziona sul robodromo un robot già precedentemente inserito con
     * addRobot. Attenzione: non pu&ograve; essere invocato quando c'è
     * un'animazione in corso.
     *

...
public abstract class Animation {
    ...
    /**
     * @return il tempo a cui l'animazione è stata aggiornata l'ultima volta
     */
    ...
    /**
     * Costante che identifica la velocità di riproduzione delle animazioni; tempo impiegato
    ...
    /**
     * 
     * @return true, se questa è un'animazione di tipo "Robot Move"
     */
    public boolean isRobotMove() {
     ...
     /**
     * 
     * @return true, se questa è un'animazione di tipo "Laser Fire"
     */
    ...
    /**
     * 
     * @return true, se questa è un'animazione di tipo "Robot Hit"
     */    
    ...
    /**
     * 
     * @return true, se questa è un'animazione di tipo "Robot Fall"
     */    
    public boolean isRobotFall() {
        ...
        /**
     * 
     * @return true, se questa è un'animazione di tipo "Transition"
     */
    ...
    /**
     * 
     * @return true, se questa è un'animazione di tipo "Laser Hide"
     */    
    ...
    /**
     * 
     * @return true, se questa è un'animazione di tipo "Pause"
     */    
    ...
    /**
     * Stabilisce se l'animazione è terminata.
     * @param elapsed il tempo passato dall'inizio dell'animazione
     * @return true se l'animazione è terminata.
     */
